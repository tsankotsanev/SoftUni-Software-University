namespace INStock.Tests
{
    ...
    public class ProductStockTests
    {
        ...
        [Test]
        public void PropertyCountShouldReturnCollectionCorrectlyCount()
        {
        ...
        [Test]
        public void IndexShouldThrowIndexOutOfRangeExceptionInAttemptToTakeProductOnInvalidIndex()
        {
        ...
        [Test]
        public void AddMethodShouldThrowExceptionWhenTryToAddExistingProduct()
        {
            this.productStock.Add(this.product);
        ...
        [Test]
        public void ContainsMethodShouldCheckIfProductIsAlreadyExistAndReturnTrue()
        {
            this.productStock.Add(this.product);
        ...
        [Test]
        public void ContainsMethodShouldCheckIfProductIsAlreadyExistAndReturnFalse()
        {
            bool expectedResult = this.productStock.Contains(product);
        ...
        [TestCase(3.00)]
        public void FindAllByPriceShouldReturnAllProductsWithThatPrice(double price)
        {
        ...
        [TestCase(4.00)]
        public void FindAllByPriceShouldReturnEmptyCollectionWithThatPrice(double price)
        {
            IProduct chia = new Product(Label, Price, Quantity);
            IProduct banana = new Product("Banana", 3.00M, 1);
            this.productStock.Add(chia);
        ...
        [TestCase(1)]
        public void FindAllByQuantityShouldReturnAllProductsWithThatPrice(int quantity)
        {
            IProduct chia = new Product(Label, Price, Quantity);
            IProduct banana = new Product("Banana", 3.00M, 1);
        ...
        [TestCase(2)]
        public void FindAllByQuantityShouldReturnEmptyCollectionWithThatPrice(int quantity)
        {
            IProduct chia = new Product(Label, Price, Quantity);
            IProduct banana = new Product("Banana", 3.00M, 1);
        ...
        [TestCase("Chia")]
        public void FindByLabelMethodShouldReturnTheSameLabelWhichIsLookingFor(string label)
        {
            CreateProduct();
        ...
        [Test]
        public void RemoveMethodShouldRemoveCorrectlyAndReturnTrue()
        {
            IProduct chia = new Product(Label, Price, Quantity);
            IProduct banana = new Product("Banana", 4.00M, 1);
        ...
        [Test]
        public void RemoveMethodShouldRemoveCorrectlyAndReturnFalse()
        {
            IProduct chia = new Product(Label, Price, Quantity);
            IProduct banana = new Product("Banana", 4.00M, 1);
