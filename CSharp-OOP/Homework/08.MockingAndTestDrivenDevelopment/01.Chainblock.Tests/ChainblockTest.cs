...
namespace _01.Chainblock.Tests
{
    [TestFixture]
    public class ChainblockTest
    {
        ...
        private const string From = "Tsanko";
        ...
        [Test]
        public void ContainsShouldCheckIfTransactionIsAlreadyAddedAndReturnTrue()
        {
        ...
        [Test]
        public void ContainsShouldCheckIfTransactionIsNotAddedAndReturnFalse()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void AddShouldAddTransactionIfIsNotAlreadyExist()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void AddShouldNotAddTransactionIfAlreadyExist()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void ContainsByIdShouldCheckIfIsAddedAndReturnTrue()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void ContainsByIdShouldCheckIfIsNotAddedAndReturnFalse()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void ChangeTransactionStatusShouldChangeStatusIfTransactionIsAlreadyExist()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void ChangeTransactionStatusShouldThrowArgumentExceptionTransactionDoesNotExist()
        {
            this.allTransactions.Add(this.transaction);
        ...
        [Test]
        public void GetByReceiverAndAmountRangeShouldReturnCollectionOfGivenReceiversWithThatAmountRange()
        {
        ...
        [Test]
        public void GetByReceiverAndAmountRangeShouldThrowInvalidOperationException()
        {
            CreateNeTransaction();

            Assert.Throws<InvalidOperationException>(() =>
            {
                this.allTransactions.GetByReceiverAndAmountRange("Tsanko", 50, 100);
            });
        }
        ...
        public void GetByReceiverOrderedByAmountThenByIdShouldThrowInvalidOperationExeption()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
            {
                this.allTransactions.GetByReceiverOrderedByAmountThenById("Tsanko");
            });
        }
        ...
        public void GetBySenderAndMinimumAmountDescendingShouldThrowInvalidOperationException()
        {
            ...
            Assert.Throws<InvalidOperationException>(() =>
            {
                this.allTransactions.GetBySenderAndMinimumAmountDescending("Tsanko", 30);
            });
        }
